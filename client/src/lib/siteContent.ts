...
大阪の感性で再編集する。`,
  ...
  intro: {
    ...
    body: "焼杉は、単なる黒い外装材ではありません。表層を炭化させることで、虫害・湿気・風雨に備えながら、木目の陰影と触感を豊かに引き出します。Yakisugi Mori は、素材の成り立ちから納まりまでをひとつの設計言語として捉え、建築家・工務店・設計事務所と伴走します。",
  },
  pillars: [
    "持続可能な森林資源",
    "日本国内での焼杉加工",
  ...
  valuesTitle: "Yakisugi Mori の取り組み",
  values: [
    {
      title: "職人性",
...
焼杉の製品群。`,
  intro:
    "Yakisugi Mori の製品は、焼き・磨き・塗装の関係によって異なる陰影をつくります。外装、内装、門扉、塀、軒天など、用途に応じて素材の見え方を整えます。",
  families: [
    {
      name: "Hakuu",
      japanese: "白雨",
...
現代建築へ。`,
  intro:
    "Yakisugi Mori は、焼杉が持つ防護性と美しさを、現代の建築言語の中で丁寧に位置づけるために生まれました。私たちは素材を売るだけでなく、表情の選定、部位の相性、経年変化の読み方まで含めて提案します。",
  sections: [
    {
      title: "焼杉の伝統",
  ...
  timeline: [
    ...
    { year: "2026", text: "Yakisugi Mori として大阪で再編集。" },
  ],
...
まずはご相談ください。`,
  intro:
    "素材選定、サンプル相談、外装・内装の納まり、着色方向、数量の考え方まで。Yakisugi Mori は大阪から、プロジェクトの初期段階に寄り添います。",
  directLabel: "お急ぎのご相談",
